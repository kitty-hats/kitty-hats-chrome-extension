			...
			<div style={{paddingTop: 25, paddingLeft: 25, paddingRight: 25}}>
				...
				<div style={{ display: 'flex', flexDirection: 'row', marginTop: '1vh'}}>
					...
					>
                        ...
                        <div>
                                <div style={{position:'fixed',bottom:0,height:'25px',width:'100%',display:'flex','flex-direction':'row-reverse','font-size':'14px'}}>

                		        <div>
						<span style={{'margin-right':'20px'}}> © Salina Labs 2018</span>
					</div>

                		        <div><a target={{_blank}} 
						href={{/privacy.html}} 
						style={{'margin-right':'20px',color:'#4babff','font-weight':500}}>
						Privacy Policy
						</a>
					</div>
